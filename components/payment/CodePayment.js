  ...
  return (
    <View style={styles.container}>
      <View style={{ flexDirection: "column", alignItems: "center" }}>
        ...
        <Text style={{ marginTop: 25, fontSize: 12, color: "grey" }}>
          Карта, с которой будут списаны деньги
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.cardInfoContainer}>
          <View style={{ flexDirection: "row", marginLeft: "10px" }}>
            <Text style={{ width: "70%", fontWeight: "bold" }}>{cardName}</Text>

            <Text style={{ width: "28%", textAlign: "right" }}>
              {lastDigits}
            </Text>
          </View>
          ...
          <View style={{ flexDirection: "row" }}>
            <View style={{ width: "75%", marginLeft: "10px" }}>
              <View style={{ flexDirection: "row" }}>
                <Text
                  style={{ fontSize: 25, fontWeight: "bold", marginRight: 6 }}
                >{`\u20B8`}</Text>
                <Text
      ...
      {isPaymentVisible ? (
        <View style={{ flexDirection: "column", alignItems: "center" }}>
          ...
          <Text
            style={{ width: "60%", fontSize: 12, color: "grey", marginTop: 20 }}
          >
            *Код транспортного средства, товара или услуги указан на терминале
            ONAY! либо на кассе.
          </Text>
        </View>
      ) : (
        <View style={{ flexDirection: "column", alignItems: "center" }}>
          ...
          <Text style={{ textAlign: "center", color: "grey" }}>Маршрут</Text>
